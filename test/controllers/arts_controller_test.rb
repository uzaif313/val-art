...
class ArtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post arts_url, params: { art: { descrption: @art.descrption, image: @art.image, users_id: @art.users_id } }
    end
  ...
  test "should update art" do
    patch art_url(@art), params: { art: { descrption: @art.descrption, image: @art.image, users_id: @art.users_id } }
